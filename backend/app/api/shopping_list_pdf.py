"""
Endpoint pour générer le PDF des listes de fournitures scolaires
...
# ✅ FIX : Écriture explicite du chemin complet '/school-lists-pdf/{list_id}/pdf' pour correspondre exactement à l'appel JS
